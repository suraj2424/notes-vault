        ...
        >
          <div className="mb-8">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h1 className="text-2xl font-bold tracking-tight text-neutral-900 dark:text-[#ededed]">Welcome back</h1>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-neutral-500 border-t border-neutral-100 pt-8 dark:text-[#888888] dark:border-[#222222]">
            ...
            <Link href="/auth/signup" className="font-medium text-neutral-700 hover:text-neutral-900 dark:text-[#888888] dark:hover:text-[#ededed]">
              Sign up
            </Link>
          </p>
        </motion.div>
