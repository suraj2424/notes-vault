...
import { X, ChevronLeft, Star, Tag, Check, Info } from "lucide-react";
...
export function NewNoteForm() {
  ...
  const stateRef = useRef({ type, title, isFavorite, tags, topicId, content, dsa, qa, user });
  stateRef.current = { type, title, isFavorite, tags, topicId, content, dsa, qa, user };
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      const noteData = {
        ...
        tags: s.tags,
        topicId: s.topicId,
        ...(s.type === "general" && { content: s.content }),
        ...(s.type === "dsa" && { dsa: s.dsa }),
        ...(s.type === "qa" && { qa: s.qa }),
      };
