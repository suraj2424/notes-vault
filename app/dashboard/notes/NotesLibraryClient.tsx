                    ...
                    {sortOptions.map((option) => (
                      <button
                        ...
                        className={cn(
                          ...
                          sortBy === option.value
                            ? "bg-neutral-200/50 font-bold text-neutral-950 dark:bg-neutral-800 dark:text-neutral-50"
                            : "text-neutral-500 hover:bg-neutral-100 dark:text-neutral-400 dark:hover:bg-neutral-800/50 hover:text-neutral-950 dark:hover:text-neutral-50",
                        )}
                      >
                        {option.label}
                      </button>
