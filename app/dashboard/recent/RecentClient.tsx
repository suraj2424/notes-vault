    ...
    <div className={dmSans.className}>
      <header className="flex items-end justify-between pb-6 dark:border-[#222222]">
        <div>
          ...
          <h1 className={cn('text-2xl tracking-tight text-neutral-900 dark:text-[#ededed]', dmSerif.className)}>
            Recent Activity
          </h1>
          <p className="mt-1 text-[13px] text-neutral-400 dark:text-[#555555]">
      ...
      {notes.length > 0 ? (
        <div className="divide-y divide-neutral-100 rounded-[10px] border border-neutral-200 bg-white overflow-hidden dark:divide-[#222222] dark:border-[#2a2a2a] dark:bg-[#161616]">
          {notes.map((note) => (
            <div
              key={note.id}
            ...
            >
              <Link href={`/dashboard/notes/${note.id}`} className="flex flex-1 items-center gap-3.5 min-w-0">
                ...
                <div className="min-w-0 flex-1">
                  <p className="truncate text-[13px] font-medium text-neutral-900 group-hover:text-neutral-600 transition-colors dark:text-[#ededed] dark:group-hover:text-[#888888]">
                    {note.title}
                  </p>
                  <p className="mt-0.5 text-[11px] text-neutral-400 capitalize dark:text-[#555555]">
        ...
        <div className="flex flex-col items-center justify-center rounded-[10px] border border-dashed border-neutral-200 bg-white py-24 text-center dark:border-[#2a2a2a] dark:bg-[#161616]">
          <Clock className="h-12 w-12 text-neutral-300 mb-4 dark:text-[#555555]" />
          <h3 className={cn('text-[17px] text-neutral-900 dark:text-[#ededed]', dmSerif.className)}>No recent activity</h3>
